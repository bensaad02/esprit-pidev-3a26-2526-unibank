...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\AdminCompteController' => 'getAdminCompteControllerService',
            'App\\Controller\\Admin\\AdminContratController' => 'getAdminContratControllerService',
            'App\\Controller\\Admin\\AdminCreditController' => 'getAdminCreditControllerService',
            'App\\Controller\\Admin\\AdminDashboardController' => 'getAdminDashboardControllerService',
            'App\\Controller\\Admin\\AdminTransactionController' => 'getAdminTransactionControllerService',
            'App\\Controller\\Admin\\AdminUserController' => 'getAdminUserControllerService',
            'App\\Controller\\Client\\ClientDashboardController' => 'getClientDashboardControllerService',
            'App\\Controller\\Client\\CompteController' => 'getCompteControllerService',
            'App\\Controller\\Client\\CreditController' => 'getCreditControllerService',
            'App\\Controller\\Client\\OffersController' => 'getOffersControllerService',
            'App\\Controller\\Client\\ProfileController' => 'getProfileControllerService',
            'App\\Controller\\Client\\TransactionController' => 'getTransactionControllerService',
            'App\\Controller\\Client\\TransactionPdfController' => 'getTransactionPdfControllerService',
            'App\\Controller\\Client\\WaitingApprovalController' => 'getWaitingApprovalControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventListener/BannedUserListener.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tFo3RKv4iQ', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JuKF5BheEg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EOLB7wkGJN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('itBK4PDcSS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\BannedUserListener')] fn () => ($container->privates['App\\EventListener\\BannedUserListener'] ?? self::getBannedUserListenerService($container)), 'onKernelRequest'], 20);
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventListener\\ExceptionListener')] fn () => ($container->privates['App\\EventListener\\ExceptionListener'] ?? $container->load('getExceptionListenerService')), 'onKernelException'], 10);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AdminCompteController', 'App\\Controller\\Admin\\AdminContratController', 'App\\Controller\\Admin\\AdminCreditController', 'App\\Controller\\Admin\\AdminDashboardController', 'App\\Controller\\Admin\\AdminTransactionController', 'App\\Controller\\Admin\\AdminUserController', 'App\\Controller\\Client\\ClientDashboardController', 'App\\Controller\\Client\\CompteController', 'App\\Controller\\Client\\CreditController', 'App\\Controller\\Client\\OffersController', 'App\\Controller\\Client\\ProfileController', 'App\\Controller\\Client\\TransactionController', 'App\\Controller\\Client\\TransactionPdfController', 'App\\Controller\\Client\\WaitingApprovalController', 'App\\Controller\\HomeController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\VerificationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventListener\BannedUserListener' shared autowired service.
     *
     * @return \App\EventListener\BannedUserListener
     */
    protected static function getBannedUserListenerService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventListener\\BannedUserListener'])) {
            return $container->privates['App\\EventListener\\BannedUserListener'];
        }

        $instance = new \App\EventListener\BannedUserListener($a, ($container->services['router'] ?? self::getRouterService($container)));

        if (isset($container->privates['App\\EventListener\\BannedUserListener'])) {
            return $container->privates['App\\EventListener\\BannedUserListener'];
        }

        return $container->privates['App\\EventListener\\BannedUserListener'] = $instance;
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RYS8y3B15e', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7gI7bpl65f', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('oCSy1pGDoH', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T9c3zsz5qW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YuceEkJWMT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4bIp1+LoHB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LGv4jTXxia', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\TransactionBancaireRepository' => ['privates', 'App\\Repository\\TransactionBancaireRepository', 'getTransactionBancaireRepositoryService', true],
            ...
            'App\\Repository\\TransactionBancaireRepository' => '?',
