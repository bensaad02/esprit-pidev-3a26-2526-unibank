 ...
 */
class getTransactionBancaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransactionBancaireRepository' shared autowired service.
     *
     * @return \App\Repository\TransactionBancaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransactionBancaireRepository.php';

        return $container->privates['App\\Repository\\TransactionBancaireRepository'] = new \App\Repository\TransactionBancaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
