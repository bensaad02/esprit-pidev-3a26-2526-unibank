...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getBanUntil(): ?\DateTimeInterface { return $this->banUntil; }
    public function setBanUntil(?\DateTimeInterface $banUntil): static { $this->banUntil = $banUntil; return $this; }
    ...
    /** Returns true if the user is currently banned (permanent or unexpired temporary) */
    public function isBanned(): bool
    {
        if ($this->estActif) return false; // active = not banned
        if ($this->banUntil === null) return true; // permanent ban
        return $this->banUntil > new \DateTime(); // temporary ban still active
    }
